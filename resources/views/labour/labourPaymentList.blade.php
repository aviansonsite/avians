...
<script>
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    { 
                        ...
                        //For so
                        $('#so').append("<option value='' class='text-muted' selected disabled>"+'Select'+"</option>");
    ...
    $(document).on("click",'.editU',function()
    {
        ...
        if(id !=""){
            ...
            $("#labour").val(labour).trigger("change");
            $("#so").val(so_id).trigger("change");
        }
    ...
    {           
        ...
        {        
            ...
            $.ajax({
                ...
                type :'get',
                data : {oth_id:oth_id,pay_desc:pay_desc,payment_date:payment_date,payment_amnt:payment_amnt,labour:labour,edit_id:edit_id,so:so},
                async: false,
                cache: true,
                dataType: 'json',
