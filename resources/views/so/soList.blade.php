                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#so_list" role="tab">
                                    ...
                                    <span class="d-none d-sm-block">OA List</span> 
                                </a>
                            </li>
                            @if($roles==1)
                                <li class="nav-item">
    ...
    {        
        ...
        {        
            ...
            $.ajax({
                ...
                url:"{{url('post_oa')}}",
                type :'post',
                data : {so_number:so_number,client_name:client_name,project_name:project_name,address:address,cp_name:cp_name,cp_ph_no:cp_ph_no,labour:labour,labours:labours,edit_id:edit_id},
                async: false,
                cache: true,
                dataType: 'json',
